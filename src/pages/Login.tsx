...
export const Login: React.FC = () => {
    ...
    useEffect(() => {
      if(!accessToken && !references){
        return;
      } else {
        const findRoute: any = routes.find((route) => route.access === references?.access_level)?.path
        navigate(findRoute)
      }
    }, [accessToken])
    return (
        ...
        <div className="flex h-screen flex-wrap items-center">
          ...
          <div className="py-2 px-26 text-center">
              ...
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                MIS Multi-Integrated Computer Monitoring & Ticketing System
              </h2>
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center justify-between">
                      ...
                      <div className="text-sm">
                        <Link
                          to={{
                            pathname: Path.forgot_password.path,
                          }}
